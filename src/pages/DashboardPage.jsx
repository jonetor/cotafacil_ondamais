...
const DashboardPage = () => {
  ...
  const canEditQuote = (quote) => {
    const approved = String(quote?.status || '').toLowerCase() === 'approved';
  ...
  const handleEditQuote = (quote) => {
    if (!canEditQuote(quote)) {
      toast({
        ...
        description: 'Vendedores não podem editar cotações aprovadas.',
      });
      return;
    }
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  {recentQuotes.length > 0 ? recentQuotes.map((quote) => {
                    ...
                    const blockedEdit = !canEditQuote(quote);
                      ...
                      >
                        <td className="py-3 px-4">
                          <p className="font-medium text-slate-200">
                            {getClientName(quote.client_id, quote.client_name)}
                          </p>
                        ...
                        <td className="py-3 px-4 text-right">
                          <Button
                            ...
                            title={
                              blockedEdit
                                ? 'Vendedores não podem editar cotações aprovadas'
                                : 'Editar cotação'
                            }
                          >
                          ...
                          <Button
                            ...
                            onClick={() => handleNotImplemented('duplicação')}
