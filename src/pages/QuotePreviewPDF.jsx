...
function QuotePreviewPDF({ quote, company, client, vendedor, autor }) {
    ...
    <div className="quote-preview p-6 bg-white text-gray-800 font-sans text-xs shadow-lg max-h-[80vh] overflow-y-auto scrollbar-hide">
      ...
      <header className="flex justify-between items-start pb-4 border-b-2 border-gray-300">
        ...
        <div className="text-right">
          ...
          <p>Validade: <span className="font-semibold">{quote.validade_proposta ? new Date(quote.validade_proposta).toLocaleDateString('pt-BR', {timeZone: 'UTC'}) : 'N/A'}</span></p>
        </div>
      </header>
      ...
      {productItems.length > 0 && (
        <section className="mt-4">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>{productItems.map((item, index) => (
      ...
      {serviceItems.length > 0 && (
        <section className="mt-4">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>{serviceItems.map((item, index) => {
      ...
      {vendedor && (
          <section className="mt-4">
            ...
            <p><span className="font-bold">{vendedor.pessoa.nomeRazao}</span></p>
      ...
      <footer className="mt-8 pt-4 border-t-2 border-gray-300">
         <p className="text-gray-500 text-xs">
            Emitido por {autor?.nomeRazao} em {new Date().toLocaleString('pt-BR', { timeZone })}
        </p>
